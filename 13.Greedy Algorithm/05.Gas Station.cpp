...
Output 1:
    ...
    Explanation 1:
        ...
        and still have 1 unit of gas left over. You fill in A[0] = 1 unit of additional gas, making your current gas = 2. It costs you B[0] = 2 to get to station 1, which you do and complete the circuit. 
...
int Solution::canCompleteCircuit(const vector<int> &A, const vector<int> &B) {
    ...
    int sum_gas=0,sum_cost=0,tank=0,start=0;
